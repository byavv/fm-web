import {
    Component, OnInit, Output, TemplateRef, ChangeDetectionStrategy,
    ChangeDetectorRef, EventEmitter, Input, ElementRef, ViewChild,
    OnChanges, AfterViewInit, Renderer, AfterViewChecked
} from '@angular/core';
